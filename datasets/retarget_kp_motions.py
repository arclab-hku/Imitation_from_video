...
# from datasets import retarget_config_aliengo_jump_sym as config # jump Aliengo symmetric
from datasets import retarget_config_aliengo_jump_inv as config # jump Aliengo inverse
